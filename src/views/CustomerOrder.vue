    ...
    export default {
        data: () => ({
            ...
            headers: [
                ...
                {text: 'Pizza', value: 'pizzaName'},
                {text: 'Size (inch)', value: 'sizeInInch'},
                {text: 'Size', value: 'sizeInText'},
                {text: 'Slice', value: 'totalSlice'},
            ...
            headers1: [
                ...
                {text: 'Regional ProvinceNamee', value: 'regionalProvinceName'},
